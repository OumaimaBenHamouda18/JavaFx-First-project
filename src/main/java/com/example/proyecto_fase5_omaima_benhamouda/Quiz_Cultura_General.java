...
public class Quiz_Cultura_General extends Quiz{

    public Quiz_Cultura_General(String nombre, String tipo, String dificultad, int tiempo, int score, ArrayList<String> preguntas, ArrayList<String> respuestas, ArrayList<String[]> opciones) {
        super(nombre, tipo, dificultad, tiempo,score, preguntas, respuestas, opciones);
    }
    public Quiz_Cultura_General() {
    }
